                    ...
                    <div className="container px-5 py-24 mx-auto">
                        ...
                        <div className="flex flex-wrap justify-evenly sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
                            <div className="p-4 md:w-1/3 flex ">
                                ...
                                <div className="flex-grow pl-6 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-all text-xl bg-gray-100 p-4 rounded-lg">
                            ...
                            <div className="p-4 md:w-1/3 flex">
                                ...
                                <div className="flex-grow pl-6 bg-gray-100 rounded-lg">
                                    <h2 className="text-gray-900 text-lg title-font font-medium mb-2 ">
                                        The Catalyzer
                                    </h2>
                                    <p className="leading-relaxed text-base">
