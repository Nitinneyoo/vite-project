export const Contact = () => {
    return (
        <div>
            ...
            <div>
                <h1 className="text-5xl font-bold text-center text-white mt-5">Contact - Us</h1>
            </div>
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-20 mx-auto flex sm:flex-nowrap flex-wrap">
                    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                        ...
                        <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                            <div className="lg:w-1/2 px-6">
                                ...
                                <p className="mt-1">
                                    Model Middle School Baghedi, Rewa, Madhya Pradesh 486226, India
                                </p>
                            </div>
                            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                                ...
                                <a className="text-indigo-500 leading-relaxed" href="mailto:example@email.com">
                                    ns442284@gmail.com
                                </a>
                    ...
                    <div className="lg:w-1/2 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 ml-2 rounded-md">
                        <h2 className="text-gray-900 text-lg mb-1 font-medium title-font ml-2">
                            Feedback
                        </h2>
                        <p className="leading-relaxed mb-5 text-gray-600 ml-4">
                            We Value Your Feedback Tell Us What You Think About Us. Your Opinion Matters To Us. Help Us Improve Our Services.share Your Thoughts with Us. We are Listening.Your Feedback Is Important.
                        </p>
